...
# (Full Version – Revenue Duplication Fully Fixed)
# ==========================================================
...
if uploaded_file:
    ...
    # Allocate Revenue Correctly (IMPORTANT FIX)
    ...
    top_20_value = top_customer_value.head(int(len(top_customer_value) * 0.2)).sum()
    ...
    # ======================================================
    # ALL ORIGINAL CHARTS (FIXED)
    # ======================================================

    # Monthly Sales (FIXED – SO LEVEL)
    ...
    # Monthly SO Count (SO LEVEL)
    monthly_so_count = so_df.groupby('Order_Month')['So_No'].nunique().reset_index()
    ...
    # Average Order Value (SO LEVEL)
    so_df['Avg_Order_Value'] = so_df['PO_Value']
    monthly_aov = so_df.groupby('Order_Month')['Avg_Order_Value'].mean().reset_index()
    ...
    # Top Customers by Value (SO LEVEL)
    ...
    # Top Products by Value (ALLOCATED FIX)
    ...
    # Customer Contribution (SO LEVEL FIX)
    ...
    # Region Contribution (SO LEVEL FIX)
